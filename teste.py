...
if __name__ == "__main__":
    ...
    if response.status_code == 200:
            ...
            while True:
                print("\nMenu:")
                print("0 - Sair")
                print("1 - Obter dados meteorológicos gerais na cidade em 7 dias")
                print("2 - Obter dados do dia atual da Cidade")
                print("3 - Obter media dos dados meteorológicos dos dias na cidade")
                print("4 - Obter dados da Hora por dia da cidade")
                print("5 - Visualizar por gráfico a media de chance de precipitação nos proximos 7 dias na Cidade")
                print("6 - Visualizar por gráfico (Hora) a chance de precipitação na Cidade")
